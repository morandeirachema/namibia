...
[![cuenta atrás](https://img.shields.io/badge/faltan-85_d%C3%ADas-C2542F?style=for-the-badge)](04-guia-preparacion.md)
...
- ✈️ **Vuelo — €1.450 por persona** ◐ *(el buscador lo anuncia en €1.341 y sube al cerrar)*.
  **No consta emitido.** Sin billete no hay e-visa.
- 🚙 **Coche — Budget N$35.100 (~€1.755)** o **Comfort N$39.000 (~€1.950)**, las dos disponibles ✅
- 🩺 **Seguro IATI — €113,02 por persona** ✅ · 🛂 **e-visa — N$1.600 (~€78)** ✅
...
- **El seguro y Damaraland**: los niveles bajos de un contrato de referencia del sector **no cubren
  ...
  por contrato** — el tour guiado es el plan.
...
14. 🗺️ [**`13-itinerario`**](13-itinerario.md) — distancias, firme y viabilidad, con el contraste de OSRM
15. 🌧️ [**`14-lluvias-historico`**](14-lluvias-historico.md) — cinco temporadas de lluvia, milímetro a milímetro
16. 🕳️ [**`15-huecos-cerrados`**](15-huecos-cerrados.md) — el cuaderno de bitácora, y **la lista maestra de lo que sigue abierto**
...
- **Al cambiar cualquier `.md`** → regenerar los PDF, que salen de estos mismos ficheros:
  ...
  puede encoger el PDF entero— están en [`CLAUDE.md`](CLAUDE.md).
