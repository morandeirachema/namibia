# El plan del guepardo — qué hacer, a qué hora, y en qué orden
...
>
> *Escrito el 26/08/2026 sobre el itinerario vigente del [`01`](../01-itinerarios-dia-a-dia.md).*
...
sol alto**, que es exactamente la parte del día que el resto del dossier trata como tiempo de
traslado.

De ahí sale la regla que ordena todo lo que sigue:

- ❌ **Más noches NO compran guepardo.** Ni una charca de noche, ni un sundowner con foco.
- ✅ **Lo que compra guepardo son kilómetros de llanura abierta a plena luz**, y esos ya están
  pagados en el itinerario: solo hay que **no gastarlos yendo deprisa**.

---

## 🚦 Lo que se perdió al dejar Namutoni, dicho con precisión

El repo cita, con razón, **Namutoni 50 % (7 de 14) — la mejor cifra de guepardo de los tres
campamentos** ◐ *(Expert Africa)*. Dos precisiones antes de darla por perdida:

- ⚠️ **Ese 50 % era por ESTANCIA**, no por charca ni por kilómetro: incluía la tarde de llegada, el
  amanecer siguiente y las salidas guiadas que se compran durmiendo allí
  *(`charcas-de-los-campamentos-de-etosha.md`)*. **Sin la noche, el número no se puede reclamar.**
- ✅ **Pero el terreno NO se ha perdido.** El 50 % no venía de la charca de Namutoni —que el propio
  dossier llama «la floja de las tres»— sino de **sus llanuras del este**, y por ahí se sigue
  pasando: **el D12 las cruza** y **el D13 es un día entero dentro de esa esquina**, entrando y
  saliendo por Von Lindequist.

👉 **Traducción**: lo que hay que recuperar no son noches, son **horas de luz en el este**. Y el
itinerario ya las tiene; el plan es no regalarlas.
...
Halali → Namutoni → salida a Onguma, **~93 km de safari** ◐. Es el día en que se cruza el este por
primera vez. **Sale del campamento en cuanto abra** y **cuenta el día como safari, no como
mudanza**: la única obligación de hora es estar fuera de Von Lindequist antes del cierre, y Onguma
está a **3,4 km de la puerta** ✅.

### 3 · D11 (mar 10) — el tramo que el dossier ya señala

**Gemsbokvlakte – Sueda – Salvadora**: el `09` lo nombra literalmente como el tramo de guepardo
✅, y el **desvío obligatorio de las obras te mete por ahí igualmente** *(`01` §D11)*. **Despacio y
con los prismáticos**, que es lo único que hay que hacer distinto.
...
- ❌ **Nadie publica la probabilidad de guepardo por kilómetro ni por tramo.** Los porcentajes de
  ...
  su clase** ◐ — sirve para saber que está, no para prometer nada.
- ❌ **Si NWR vende sus salidas guiadas a quien no pernocta**, no está verificado *(`01` §D12)*. Si
  las vendiera, la **guiada de mañana de Namutoni** volvería al plan y sería la ventana nº 2.
- ❌ **El «night drive» de Onguma no figura en su tarifario 2027**; el que existe es el sundowner
  *(`../21-campamentos-de-etosha.md`)*. Para guepardo da igual, pero conviene no contarlo dos veces.

---

*Precios en N$ y € · ~N$20 = €1 · Porcentajes por estancia de Expert Africa, registros de GBIF ·
Las tarifas namibias cambian: reconfirma antes de pagar*
