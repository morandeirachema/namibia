...
flowchart LR
%% ancho
    T["LO QUE CUESTA CADA JOYA<br/>medido con OSRM, no estimado"]
    A["SPITZKOPPE<br/>como VARIANTE: -203 km<br/>pero borra la Costa<br/>de los Esqueletos"]
    B["VINGERKLIP<br/>+111 km en el D9<br/>que ya son 343"]
    C["WATERBERG<br/>+151 km en el D13<br/>que ya son 539"]
    D["ERONGO / OMARURU<br/>+97 km en el D13<br/>el mas barato"]
    E["BRANDBERG<br/>+262 km ida y vuelta<br/>desde Twyfelfontein"]
    T --> A
    T --> D
    T --> B
    T --> C
...
Otjiwarongo** ◐ — es decir, **pegada al eje del D13**, el día de vuelta a Windhoek. No estaba en
...
- **El desvío, medido** ✅: **+89 km** sobre el trazado directo del D13 *(OSRM)*.
- **⏰ Y aquí está el detalle que decide**, con los tiempos reales medidos:
  - **Onguma → CCF son 280 km, ~3 h 30** a velocidad de planificación. Saliendo a las 08:00 se
    llega sobre las **11:30** — **la alimentación de las 14:00 entra de sobra**, y el **D13 es
...
Ya estaba en el dossier *(`11`)*: **C40, a 24 km de Kamanjab, de camino el D9** — **~N$610
...
- ⚠️ **Dos cosas que confirmar antes de contar con ello**: la hora de la alimentación —el dossier
  ...
  fuentes que lo dan cerrado los fines de semana** ◐. **Vuestro D9 es lunes 9 de noviembre**, así
...
**Del guepardo**: la ruta ya trae tres oportunidades sin mover una sola noche —el **D11 en
