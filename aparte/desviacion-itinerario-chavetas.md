...
flowchart LR
    ...
    ET -->|"Isaac: 2 noches FUERA,<br/>salida por el norte"| HO["meteorito<br/>Hoba"] --> TS["Tsumkwe<br/>Nyae Nyae"] --> WB["Waterberg"] --> W1
    style TB fill:#0a9396,color:#fff
    style HO fill:#ee9b00,color:#000
    style TS fill:#ee9b00,color:#000
    style WB fill:#ee9b00,color:#000
```
