...
- **Bolsas zip / saco estanco pequeño** ○ para la electrónica: el polvo de la grava se mete por
  todo (la calima y el corrugado de `05` también van por dentro del coche).
...
- **Pasaportes** ✅: válidos hasta el **15/05/2027 mínimo** y **3 páginas en blanco de verdad** (`03`)
- **e-visa impreso y firmado** ✅ + copia (`03` — solo el portal `eservices.mhaiss.gov.na`)
...
- **Billetes, reservas de NWR/Terrace Bay/coche impresas** ✅ (Terrace Bay: sin reserva impresa no
  entras al parque, `06`)
- **Carné de conducir + permiso internacional** — ⚠️ si es obligatorio **sigue sin resolver** (`01`):
  está en la cuenta atrás de septiembre (`03`)
- **Cartilla de vacunación** (la amarilla solo si el itinerario cambiara — con las escalas cortas
  de Adís **no hace falta**, `03`/README)
- ○ Copias: fotocopias de todo en una bolsa aparte del original + fotos en el móvil (offline)

## 🩺 Salud y botiquín

- **Profilaxis de malaria** según lo que diga el CVI ✅ (`03`): si es Malarone, se empieza ya de
...
- **Repelente con DEET** ○ (Etosha es zona de malaria ✅, aunque tu ventana es el mínimo
  estacional — `03`): manga larga ligera al anochecer en Etosha ○
...
- **Sales de rehidratación oral** ○ — con 35–38 °C y aire seco, la deshidratación va por delante
  de la sed. Y la regla del agua ✅ (`05`/FCDO): **4+ L por persona y día EN el coche**
...
- **2 adaptadores tipo M** ◐ (`03`) — pedidos online YA, no existen en súper españoles
- **Cargador 12 V multi-USB** ○ para el coche (los 12 V «se saltan el problema entero», `03`) +
...
- **El satelital con SOS** (Garmin inReach o similar) — el dossier lo recomienda sin ambigüedad
  para ESTA ruta ✅ (`05`/`07`: «el móvil es una cámara, no un salvavidas» en Solitaire–Walvis y
  Damaraland). **Decisión de compra/alquiler aún pendiente** (`03`)
- **Prismáticos — uno POR PERSONA** ○ (compartir prismáticos en una charca es pelearse) — y van
  «EN el asiento, no en el maletero» (`11`)
- Cámara: **tele** para fauna ○ · **trípode** para la charca iluminada de noche y el cielo del
  ...
  antipolvo** ○
- Móvil: **Tracks4Africa** ✅ (`04` lo exige para verificar etapas) + mapas offline + los teléfonos
  de emergencia de `07` grabados **y en papel en la guantera** ✅

## 👕 Ropa *(14 días, lavado a mano posible ○)*

- **La corrección de premisa de `03` manda**: forro polar (1), **cortavientos/chubasquero ligero**
...
- ○ 4–5 camisetas transpirables + 2 camisas de manga larga ligeras (sol y mosquitos: valen más que
  ...
  ~7 días · **bañador** (piscinas de Okaukuejo/Halali/Namutoni ✅ `11`, y la de Halali es plan de
...
- Mechero ×2 y pastillas de encendido (la leña resinosa de algunos campings, `13`)
...
- Libreta y boli — para apuntar las **presiones en frío** que te den en la entrega ✅ (`05`)

**No 🚫:**
- ❌ Plumas, térmicos, gorro y guantes ◐ (`03`) — peso muerto
- ❌ Maleta rígida grande ○ — no cabe bien
- ❌ Saco de dormir, esterilla, hornillo, menaje ✅ — el coche lo trae TODO (README)
- ❌ Comida de casa en cantidad — el avituallamiento está resuelto y mapeado en `13`
...
- ❌ Y a la vuelta: **nada de biltong ni carne en el petate** — prohibido entrar en la UE ✅ (`13`)
...
- **Kit charca nocturna (D9–D12)**: forro, frontal en rojo, prismáticos, trípode, silencio y
  paciencia (`11`: apaga y dale 15–20 min).
...
el dossier — se compran fuera o allí (`13`). Lo heredado de fichas del coche depende del
**inventario POR ESCRITO** pendiente con Namibia2Go (`03`): toallas, almohadas y detalle del menaje
