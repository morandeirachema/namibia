...
```mermaid
xychart-beta
    title "4x4 con camping · solo alquiler · en EUR · octubre vs tras 15 nov"
    x-axis ["12 dias oct", "12 dias nov", "13 dias oct", "13 dias nov", "14 dias oct", "14 dias nov"]
    y-axis "EUR" 0 --> 2700
    bar [2148, 1404, 2327, 1521, 2506, 1638]
```
...
```mermaid
xychart-beta
    title "Okaukuejo · chalet del charco · por noche · 2 personas · en NAD"
    x-axis ["Octubre", "Noviembre"]
    y-axis "NAD" 0 --> 8000
    bar [6960, 4760]
```
...
```mermaid
flowchart LR
    A["Viajar<br/>oct-dic 2026"] --> B{"¿Antes o despues<br/>del 15 nov?"}
    B -->|"Octubre"| C["Coche: €2.506<br/>(~N$50.100)"]
    B -->|"Tras 15 nov"| D["Coche: €1.638<br/>(~N$32.800)"]
    C --> E["NWR tarifa alta<br/>Chalet: N$6.960/noche"]
    D --> F["NWR tarifa baja<br/>Chalet: N$4.760/noche"]
    E --> G["❓ Mejor fauna<br/>y menos lluvia"]
    F --> H["❓ ¿Lluvias?<br/>¿Calor? ¿Malaria?"]
    G --> I["VEREDICTO<br/>pendiente"]
    H --> I
...
```mermaid
flowchart TD
    R["README<br/>(estás aquí)"]
    D1["01 · Hallazgos verificados<br/>✅ Alquiler · seguros<br/>visado · tasas"]
    D2["02 · Alojamiento y tasas<br/>✅ Tarifas NWR 2026/27"]
    D3["03 · Veredicto de fechas<br/>🔬 Lluvia · calor · fauna"]
    D4["04 · Itinerario<br/>🔬 Ruta y viabilidad"]
    D5["05 · Alojamientos<br/>🔬 Lodges y reservas"]
    D6["06 · Presupuesto<br/>🔬 Camping vs lodges"]
    R --> D1 --> D2
    D2 --> D3 --> D4 --> D5 --> D6
    D6 --> FIN["Decisión final<br/>y reservas"]
    style D1 fill:#2d6a4f,color:#fff
    style D2 fill:#2d6a4f,color:#fff
    style D3 fill:#e85d04,color:#000
    style D4 fill:#e85d04,color:#000
    style D5 fill:#e85d04,color:#000
    style D6 fill:#e85d04,color:#000
```
...
```mermaid
xychart-beta
    title "Camping NWR · precio por persona y noche · nov-dic 2026 · en NAD"
...
```mermaid
xychart-beta
    title "Alojamiento NWR · 2 personas por noche · nov-dic 2026 · en NAD"
    x-axis ["Halali doble", "Namutoni doble", "Okaukuejo doble", "Okaukuejo charco", "Dolomite (MP)", "Sossus Dune (MP)"]
    y-axis "NAD · 2 personas" 0 --> 9000
    bar [2800, 3680, 3800, 4760, 6360, 8060]
```
...
```mermaid
flowchart LR
    E["Entras en<br/>un parque"] --> P["N$280 (~€14)<br/>por adulto"]
    E --> V["N$60 (~€3)<br/>por vehículo"]
    P --> T["2 adultos + coche<br/><b>N$620 (~€31)</b>"]
    V --> T
    T --> R["Se repite cada<br/>24 h y en<br/>CADA parque"]
    R --> X["3 días en Etosha<br/>= 3 veces"]
    style T fill:#2d6a4f,color:#fff
    style X fill:#e85d04,color:#000
```
...
block-beta
    columns 4
    A["Standard<br/>€0/día<br/>N$40.000"]
    B["Reduced 1<br/>€8/día<br/>N$20.000"]
    C["Reduced 2<br/>€15/día<br/>N$5.000"]
    D["Super Cover<br/>€25/día<br/>N$0"]
    E["❌ Sin neumáticos · sin cristales · sin bajos · sin vuelcos"]:3
    F["✅ Único útil"]:1
...
```mermaid
flowchart LR
    A["Límite nacional<br/>100 km/h"] -.->|"pero el contrato<br/>manda"| B["Asco impone<br/><b>80 km/h</b> en grava"]
    B --> C["Caja negra registra<br/>velocidad y posición"]
    C --> D{"¿Accidente?"}
    D -->|"Sí"| E["Leen los datos"]
    E --> F["Si ibas a más de 80:<br/><b>seguro anulado</b>"]
...
```mermaid
flowchart LR
    A["Búsqueda<br/>multi-fuente"] --> B["Se extrae una<br/>afirmación falsable"]
    B --> C["3 verificadores<br/>independientes<br/>intentan REFUTARLA"]
    C --> D{"¿2 de 3<br/>la refutan?"}
    D -->|"Sí"| E["❌ REFUTADA<br/>no se publica"]
    D -->|"No"| F["✅ VERIFICADA<br/>con enlace"]
    D -->|"Sin fuente"| G["🕳️ EN BLANCO<br/>a propósito"]
    style E fill:#9d0208,color:#fff
    style F fill:#2d6a4f,color:#fff
