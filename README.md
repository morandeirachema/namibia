...
```mermaid
xychart-beta
    title "4x4 con camping + Super Cover · total en EUR"
    x-axis ["12 dias oct", "12 dias nov", "13 dias oct", "13 dias nov", "14 dias oct", "14 dias nov"]
    y-axis "EUR" 0 --> 3000
    bar [2448, 1704, 2652, 1846, 2856, 1988]
```
...
```mermaid
timeline
    title Inicio efectivo de las lluvias en Etosha
    2021/22 : ENERO 2022
...
flowchart TD
    ...
    W --> C["CENTRO Y COSTA<br/>Etosha · Swakopmund<br/>Sossusvlei · Damaraland<br/>✅ el nucleo"]
