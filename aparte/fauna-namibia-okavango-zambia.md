...
flowchart LR
%% ancho
    N["NAMIBIA · vuestra ruta<br/>DESIERTO Y SABANA SECA<br/>la fauna se concentra en las charcas<br/>especialistas adaptados a la sequia"]
    O["OKAVANGO · Botsuana<br/>HUMEDAL PERMANENTE<br/>antilopes semiacuaticos, hipopotamo,<br/>cocodrilo, y licaon con las mayores<br/>densidades de manada de Africa"]
    Z["ZAMBIA · valle del Luangwa<br/>VALLE FLUVIAL<br/>densidad altisima, tres subespecies<br/>que no existen en ningun otro sitio<br/>y el leopardo"]
    style N fill:#C2542F,color:#fff
    style O fill:#2F6E8E,color:#fff
    style Z fill:#5F7043,color:#fff
```
