...
flowchart LR
%% ancho
    T["Lo que cuesta cada camino<br/>EUR · vistos el 08-08-2026"]
...
```mermaid
flowchart TD
    A["¿Hay ya en casa una camara<br/>con 400 mm equivalentes?"] -->|"si"| B["Llevadla y gastad 0:<br/>pera, panos y bolsa estanca<br/>ya estan en el 17"]
    A -->|"no"| C{"¿Cuanto duele<br/>el bolsillo?"}
    C -->|"~950 EUR"| D["P1100<br/>bridge todo en uno<br/>de noche sufre"]
    C -->|"~2.000-2.600 EUR"| E["R7 + RF 100-400<br/>o Z50II + 28-400<br/>y el equipo se queda"]
    C -->|"~1.000 EUR<br/>sin comprar nada"| F["ProHire en Windhoek<br/>kit Sony asegurado<br/>confirmar tarifa 26/27"]
    style B fill:#2d6a4f,color:#fff
    style E fill:#2d6a4f,color:#fff
    style F fill:#7a3a22,color:#fff
```
