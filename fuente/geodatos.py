...
INTERES = [
    ...
    ("Etosha Trading Post", "Etosha Trading Post", "compra", ["D10"]),
    ("Okahandja Craft Market", "Tallistas de Okahandja", "compra", ["D14"]),
    # --- las joyas del `10`, en el orden en que caen. Lo que Nominatim no encuentra queda
    # --- fuera del mapa y anotado en `sin_resultado`: no se pone una coordenada a ojo.
    ("Heroes Acre", "Heroes' Acre", "joya", ["D2"]),
    ...
    ("Bird Rock, Walvis Bay", "Bird Rock · plataforma de guano", "joya", ["D6", "D7"]),
    ("Wlotzkasbaken", "Wlotzkasbaken", "joya", ["D7"]),
    ("Zeila wreck", "Pecio Zeila", "joya", ["D7"]),
    ("Toscanini, Kunene", "Torre del Toscanini · cormoranes", "joya", ["D7"]),
    ("Uniab River Delta", "Delta del Uniab", "joya", ["D7", "D8"]),
    ("Wondergat, Kunene", "Wondergat", "joya", ["D8"]),
    ("Damara Living Museum", "Damara Living Museum", "joya", ["D8"]),
    ("Organ Pipes, Kunene", "Organ Pipes", "joya", ["D8"]),
    ("Burnt Mountain, Kunene", "Burnt Mountain", "joya", ["D8"]),
    ("Petrified Forest, Khorixas", "Petrified Forest · +60 km", "joya", ["D8"]),
    ("Grootberg Lodge", "Grootberg Lodge · rastreos", "joya", ["D9"]),
    ("Peet Alberts Koppie", "Peet Alberts Koppie · grabados", "joya", ["D10"]),
    ("Outjo Museum", "Franke House · museo de Outjo", "joya", ["D10"]),
    ("Lake Otjikoto", "Lago Otjikoto", "joya", ["D14"]),
    ("Tsumeb Museum", "Museo de Tsumeb", "joya", ["D14"]),
    ("Khorab Memorial", "Memorial de Khorab", "joya", ["D14"]),
    ("Crocodile Farm, Otjiwarongo", "Crocodile Farm", "joya", ["D14"]),
    ("Hoba Meteorite", "Meteorito de Hoba · +93 km", "joya", ["D14"]),
    ("Post Street Mall, Windhoek", "Meteoritos de Gibeon", "joya", ["D15"]),
    ("Telephone Man, Windhoek", "Telephone Man · Lone Men", "joya", ["D15"]),
]
