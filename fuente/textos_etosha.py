...
DONDE = {
  ...
  "babuino-chacma": "En esta ruta, los miradores y áreas de descanso de la escarpa (D2) y de Damaraland (D8–D9) — en Etosha apenas figura. Ventanillas arriba si os alejáis con comida a la vista.",
  ...
  "rata-dassie": "**Twyfelfontein (D8)**: las peñas del propio yacimiento, donde se concentran las observaciones — y los roquedos de la escarpa: también está citada en el paso de Spreetshoogte (D2).",
  ...
  "estornino-naburup": "Los aparcamientos y picnics de **Sesriem/Sossusvlei (D3–D4)** —unos 200 por viaje cuentan los tours— y los acantilados de Damaraland (D8–D9), donde cría junto a los inseparables.",
  ...
  "lorito-ruppell": "Los **cauces arbolados de Damaraland (D8–D9)**: citado en el propio cauce del Aba Huab, junto al campamento comunitario de Twyfelfontein.",
  "toco-angoleno": "Su casa es la **escarpa rocosa (D8–D9)**: Twyfelfontein y Grootberg. En Etosha solo asoma por los cerros del oeste — fuera de vuestro eje.",
  "inseparable-namibia": "Roquedos de **Damaraland (D8–D9)**, en colonias junto al estornino Naburup — y en los pajares del tejedor republicano: la ficha del tejedor ya los citaba de inquilinos.",
  ...
  "aguila-cafre": "**El alto del paso de Spreetshoogte / Namibgrens (D2)**: una pareja se cita año tras año (nov 2016, oct 2017, oct 2025). También en el Naukluft camino de Solitaire (sep 2023) y en Khowarib, al norte del paso de Grootberg (oct 2024).",
  ...
  "busardo-augur": "**Namibgrens / paso de Spreetshoogte (D2)** —7 nov 2016; 31 oct y 1 nov 2023— y la carretera **Kamanjab→Okaukuejo** (D10); también en Khowarib, al norte de Grootberg (oct 2024).",
  "busardo-augur-meridional": "**El paso de Spreetshoogte (D2)** —«bastante raro aquí, en el extremo norte de su área», oct 2012— y la carretera Solitaire–Remhoogte (dic 2002).",
